...
export default function Home() {
  ...
  return (
    <motion.div 
    className="min-h-screen w-full bg-background/35 text-foreground overflow-hidden rounded"
    initial={{ opacity: 0 }}
    animate={{ opacity: 1 }}
  ...
  >
      ...
      >
        <section className="flex flex-col items-center justify-center gap-12 py-12 px-4 md:px-6">
          {/* Hero Section */}
          <motion.div 
            className="w-full max-w-6xl rounded-2xl bg-black/66 backdrop-blur-lg p-8 shadow-lg border border-content3/20"
            initial="hidden"
            whileInView="visible"
